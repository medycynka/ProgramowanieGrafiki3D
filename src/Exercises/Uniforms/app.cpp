...
void SimpleShapeApplication::init() {
    ...
    glBufferData(GL_UNIFORM_BUFFER, 9 * sizeof(GLfloat), nullptr, GL_STATIC_DRAW);
    ...
    glBindBuffer(GL_UNIFORM_BUFFER, 0);
    glm::vec3 light_color = {0.45f, 0.0f, 0.9f};
    glBindBuffer(GL_UNIFORM_BUFFER, ubo_handle);
    glBufferSubData(GL_UNIFORM_BUFFER, 4 * sizeof(GLfloat), 4 * sizeof(GLfloat), glm::value_ptr(light_color));
    glBindBuffer(GL_UNIFORM_BUFFER, 0);
